...
type PawnMove = PawnMoveNonPromotion | PawnMovePromotion;
...
type PawnCapture = PawnCaptureNonPromotion | PawnCapturePromotion;

// Note: "e.p." suffix (e.g., "exd6 e.p.") is intentionally not supported; normalize at parse time if needed
type EnPassant = `${File}x${File}${3 | 6}${CheckSuffix}`;
