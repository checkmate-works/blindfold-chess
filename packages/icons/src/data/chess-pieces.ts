...
function getPawnData(color: PieceColor): PieceSvgData {
  return {
    viewBox: VIEWBOX,
    elements: [
      {
...
function getRookData(color: PieceColor): PieceSvgData {
  if (color === "w") {
    return {
      viewBox: VIEWBOX,
      elements: [
        {
          ...
          children: [
            ...
            { type: "path", d: "m34 14-3 3H14l-3-3" },
            {
              type: "path",
              strokeLinecap: "butt",
            ...
            { type: "path", d: "m31 29.5 1.5 2.5h-20l1.5-2.5" },
            {
              type: "path",
              fill: "none",
              strokeLinejoin: "miter",
...
function getKnightData(color: PieceColor): PieceSvgData {
  const elements: PieceSvgData["elements"] = [
    {
      type: "group",
      fill: "none",
      fillRule: "evenodd",
  ...
  return { viewBox: VIEWBOX, elements };
}

function getBishopData(color: PieceColor): PieceSvgData {
  return {
    viewBox: VIEWBOX,
    elements: [
      {
...
function getQueenData(color: PieceColor): PieceSvgData {
  if (color === "w") {
    return {
      viewBox: VIEWBOX,
      elements: [
        ...
        children: [
          {
            ...
            stroke: "none",
            children: [
              { type: "circle", cx: "6", cy: "12", r: "2.75" },
              { type: "circle", cx: "14", cy: "9", r: "2.75" },
              { type: "circle", cx: "22.5", cy: "8", r: "2.75" },
              { type: "circle", cx: "31", cy: "9", r: "2.75" },
              { type: "circle", cx: "39", cy: "12", r: "2.75" },
            ],
          },
          {
            type: "path",
...
function getKingData(color: PieceColor): PieceSvgData {
  const children: PieceSvgData["elements"] = [
    {
      type: "path",
      strokeLinejoin: "miter",
      d: color === "w" ? "M22.5 11.63V6M20 8h5" : "M22.5 11.6V6",
    },
    {
      type: "path",
      fill: color === "w" ? "#fff" : "#000",
    ...
    ...(color === "b"
      ? ([
        ...
        ] satisfies PieceSvgData["elements"])
      : []),
    {
      type: "path",
...
export function getPieceData(
  ...
  switch (piece) {
    case "p":
      return getPawnData(color);
    case "r":
      return getRookData(color);
    case "n":
      return getKnightData(color);
    case "b":
      return getBishopData(color);
    case "q":
      return getQueenData(color);
    case "k":
      return getKingData(color);
  }
}
