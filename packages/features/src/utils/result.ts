/**
 * Minimal `Result<T, E>` type for domain operations.
 *
 ...
 *
 * Originally scoped to `ai-game/opponent`; promoted here once the engine
 * factories in `apps/web/src/lib/engines/` became a second consumer.
 */
