...
type Props = {
   ...
   * Defaults to true because the current caller (`/games/play` victory)
   * renders the frame above the fold as the page's hero.
   */
  priority?: boolean;
};
 ...
 *
 * Used by `VictoryCertificate` — the AI defeat result on `/games/play`.
 *
