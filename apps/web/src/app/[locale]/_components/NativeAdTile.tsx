...
/**
 * Native ad tile — the `native_tile` kind's renderer, shaped like the module
 * tiles of the `/practice` grid it sits in: the same rounded, bordered card
 * surface and hover lift, a chrome line above the title, an emoji before it,
 * and the creative's thumbnail where a module's example band goes.
 *
 ...
 */
export function NativeAdTile({ creative, className }: Props) {
