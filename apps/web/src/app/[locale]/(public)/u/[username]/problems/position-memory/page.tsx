...
export async function generateMetadata(props: Props): Promise<Metadata> {
  return generateProblemsTypeMetadata(props, 'memory');
}

export default function PositionMemoryProblemsPage(props: Props) {
  return <ProblemsTypePage {...props} type="memory" />;
}
