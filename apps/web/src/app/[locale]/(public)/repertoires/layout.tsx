...
/**
 * Subtree providers: the 'repertoires' client dictionary (see
 ...
 */
export default async function RepertoiresLayout({ children, params }: Props) {
  const { locale } = await params;
  return (
    <ScopedIntlProvider scope="repertoires" locale={locale}>
