...
/**
 * Subtree providers: the 'topics' client dictionary (see
 ...
 */
export default async function TopicsLayout({ children, params }: Props) {
  const { locale } = await params;
  return (
    <ScopedIntlProvider scope="topics" locale={locale}>
