...
async function invoke(locale: Locale, period?: string | string[] | undefined): Promise<string> {
  ...
  return vi.mocked(permanentRedirect).mock.calls[0][0];
}
...
describe('ScoreLeaderboardIndexRedirect', () => {
  describe('period query param handling', () => {
    ...
    it('extracts first element when period is an array', async () => {
