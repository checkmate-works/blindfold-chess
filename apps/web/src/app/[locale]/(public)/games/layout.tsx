...
/**
 * Subtree providers: the 'games' client dictionary (see
 ...
 */
export default async function GamesLayout({ children, params }: Props) {
  const { locale } = await params;
  return (
    <ScopedIntlProvider scope="games" locale={locale}>
