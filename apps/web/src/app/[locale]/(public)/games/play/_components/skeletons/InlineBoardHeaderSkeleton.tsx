 ...
 * Real UI is a card-styled wrapper (`bg-card rounded-md shadow-sm border
...
export function InlineBoardHeaderSkeleton() {
  return (
    <div aria-hidden className="overflow-hidden rounded-md border border-border bg-card shadow-sm">
