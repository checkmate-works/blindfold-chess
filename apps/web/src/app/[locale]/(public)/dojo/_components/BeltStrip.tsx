...
export function BeltStrip({ slug, rankName }: BeltStripProps) {
  ...
  return (
    ...
    >
      ...
      <span className="text-sm font-medium text-foreground sm:text-base">{rankName}</span>
    </div>
  );
}
