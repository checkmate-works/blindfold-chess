...
const contentRegistry: Record<string, Record<Locale, () => Promise<string>>> = {
  'algebraic-notation': {
    ...
    pt: () => import('../_content/algebraic-notation/pt').then((m) => m.default),
  },
  'anchor-squares': {
    ...
    pt: () => import('../_content/anchor-squares/pt').then((m) => m.default),
  },
  'bishop-movement': {
    ...
    pt: () => import('../_content/bishop-movement/pt').then((m) => m.default),
  },
  'board-symmetry': {
    ...
    pt: () => import('../_content/board-symmetry/pt').then((m) => m.default),
  },
  'coordinate-confusion': {
    ...
    pt: () => import('../_content/coordinate-confusion/pt').then((m) => m.default),
  },
  'de-groot-experiment': {
    ...
    pt: () => import('../_content/de-groot-experiment/pt').then((m) => m.default),
  },
  diagonals: {
    ...
    pt: () => import('../_content/diagonals/pt').then((m) => m.default),
  },
  'fen-notation': {
    ...
    pt: () => import('../_content/fen-notation/pt').then((m) => m.default),
  },
  'king-movement': {
    ...
    pt: () => import('../_content/king-movement/pt').then((m) => m.default),
  },
  'knight-movement': {
    ...
    pt: () => import('../_content/knight-movement/pt').then((m) => m.default),
  },
  'knight-tour': {
    ...
    pt: () => import('../_content/knight-tour/pt').then((m) => m.default),
  },
  'position-memory': {
    ...
    pt: () => import('../_content/position-memory/pt').then((m) => m.default),
  },
  'rook-movement': {
    ...
    pt: () => import('../_content/rook-movement/pt').then((m) => m.default),
  },
  'square-colors': {
    ...
    pt: () => import('../_content/square-colors/pt').then((m) => m.default),
  },
};
...
const metadataRegistry = {
  'algebraic-notation': {
    ...
    pt: () => import('../_content/algebraic-notation/metadata.pt'),
  },
  'anchor-squares': {
    ...
    pt: () => import('../_content/anchor-squares/metadata.pt'),
  },
  'bishop-movement': {
    ...
    pt: () => import('../_content/bishop-movement/metadata.pt'),
  },
  'board-symmetry': {
    ...
    pt: () => import('../_content/board-symmetry/metadata.pt'),
  },
  'coordinate-confusion': {
    ...
    pt: () => import('../_content/coordinate-confusion/metadata.pt'),
  },
  'de-groot-experiment': {
  ...
  'fen-notation': {
    ...
    pt: () => import('../_content/fen-notation/metadata.pt'),
  },
  'king-movement': {
    ...
    pt: () => import('../_content/king-movement/metadata.pt'),
  },
  'knight-movement': {
    ...
    pt: () => import('../_content/knight-movement/metadata.pt'),
  },
  'knight-tour': {
    ...
    pt: () => import('../_content/knight-tour/metadata.pt'),
  },
  'position-memory': {
    ...
    pt: () => import('../_content/position-memory/metadata.pt'),
  },
  'rook-movement': {
    ...
    pt: () => import('../_content/rook-movement/metadata.pt'),
  },
  'square-colors': {
    ...
    pt: () => import('../_content/square-colors/metadata.pt'),
  },
} as const;
