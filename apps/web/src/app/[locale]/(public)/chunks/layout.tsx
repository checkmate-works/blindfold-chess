...
/**
 * Subtree providers: the 'chunks' client dictionary (see
 ...
 */
export default async function ChunksLayout({ children, params }: Props) {
  const { locale } = await params;
  return (
    <ScopedIntlProvider scope="chunks" locale={locale}>
