...
/**
 * Subtree providers: the 'practice' client dictionary (see
 ...
 */
export default async function PracticeLayout({ children, params }: Props) {
  const { locale } = await params;
  return (
    <ScopedIntlProvider scope="practice" locale={locale}>
