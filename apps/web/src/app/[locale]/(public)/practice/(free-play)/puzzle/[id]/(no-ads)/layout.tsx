 ...
 * slots. Ad-related Server Components (e.g., `AdSenseGuard`, and any in-feed
 * slot consumers' inline guard) consult `isNoAdsScope()` via `resolveAdGuard()`
 * and short-circuit to `hidden` — nothing is rendered in the DOM.
 *
