...
/**
 * Subtree providers: the 'preferences' client dictionary (see
 ...
 */
export default async function PreferencesLayout({ children, params }: Props) {
  const { locale } = await params;
  return (
    <ScopedIntlProvider scope="preferences" locale={locale}>
